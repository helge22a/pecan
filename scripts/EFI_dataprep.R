...
#   }
# }
#new fcn taken from eco4cast/neon4cast/s3_helpers.R https://github.com/eco4cast/neon4cast/blob/main/R/s3_helpers.R
...
download_s3_objects(dir = base_dir[i], bucket = "drivers", 
                    prefix = paste0("noaa/NOAAGEFS_1hr/",sitename[i],"/",as.Date(start_date),"/","00"),
